...
!!      write(*,*)dble([character(len=10) :: &
!!       & '111','222.222','333.333d0'])+444.444d0
!!
...
! ident_2="@(#)M_strings::adjustl_atleast(3f): return string padded on right to at least specified length"
...
! ident_3="@(#)M_strings::adjustr_atleast(3f): return string padded on left to at least specified length"
