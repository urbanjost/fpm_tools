...
! ident_1="@(#)fpm-findll(1f): find long lines"
...
'NAME                                                                            ',&
'   fpm-findll(1f) - [FILE FILTER] find long lines                               ',&
'   (LICENSE:PD)                                                                 ',&
'SYNOPSIS                                                                        ',&
'   fpm-findll [ -l LENGTH] [ -wrap] | [ -help| -version] [FILENAMES]            ',&
'DESCRIPTION                                                                     ',&
...
'@(#)PROGRAM:        fpm-findll(1)>',&
'@(#)LICENSE:        MIT>',&
'@(#)DESCRIPTION:    find long lines>',&
'@(#)VERSION:        23.1 20160618>',&
'@(#)AUTHOR:         John S. Urban>',&
'@(#)COMPILED:       Wed, Nov 4th, 2020 12:11:46 AM>',&
'']
