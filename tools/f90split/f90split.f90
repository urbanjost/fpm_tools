...
use splitdefs
use splitcurs
use M_CLI2, only : set_args                  ! add command-line parser module
!!implicit none
!
...
'@(#)PROGRAM:        f90split(1)>',&
'@(#)DESCRIPTION:    split a Fortran 90 source file into component files>',&
...
'@(#)AUTHOR:         John S. Urban>',&
'@(#)COMPILED:       Wed, Nov 4th, 2020 12:11:56 AM>',&
'']
